...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A00), 0x800005DBu);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0xFF000000u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL3), 0x0000EEFFu);
	...
	CY_SET_REG32((void *)(CYDEV_PRT0_BASE), 0x000000E1u);
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x00D90006u);
	CY_SET_REG32((void *)(CYREG_PRT0_PC2), 0x000000C0u);
	...
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x00000002u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC), 0x00000010u);

	/* IOPINS0_3 Starting address: CYDEV_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT3_BASE), 0x00000001u);
	CY_SET_REG32((void *)(CYREG_PRT3_PC), 0x00000D8Eu);
